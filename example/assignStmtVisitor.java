...
public class assignStmtVisitor extends SimpleCBaseVisitor<Void>{
	...
	private HashMap<String,Integer> varIndex = new HashMap<String,Integer>();
	private String declaration;
	private ArrayList<String> varList = new ArrayList<>();
	private String num = "0123456789";
	
	
	public assignStmtVisitor (HashMap<String,Integer> varIndex){
	...
	public Void visitAssignStmt(SimpleCParser.AssignStmtContext ctx){
		...
		if(assignStmt == null){
			assignStmt = setAssignStmt(varIndex,left) + "\n";
		}
		else 
			assignStmt = assignStmt + setAssignStmt(varIndex,left) + "\n";
		return null;
	}
	...
	public String setAssignStmt(HashMap<String, Integer> varIndex, String id ){
